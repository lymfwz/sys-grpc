...
def main(config):
    ...
    for filename in filenames:
        ...
        if ext =='.tif':
            ...
            # data_list.append('FGS_'+filename+'.tif')
            # GT_list.append('FGS_'+filename+'_segmentation.tif')
            data_list.append('FGS_'+filename+'.png')
            GT_list.append('FGS_GT_'+filename+'.png')
...
if __name__ == '__main__':
    ...
    # data path
    parser.add_argument('--origin_data_path', type=str, default='./FGS/dataset/IMAGES')
    parser.add_argument('--origin_GT_path', type=str, default='./FGS/dataset/GT2')
    
    parser.add_argument('--train_path', type=str, default='./dataset03/train/')
    parser.add_argument('--train_GT_path', type=str, default='./dataset03/train_GT/')
    parser.add_argument('--valid_path', type=str, default='./dataset03/valid/')
    parser.add_argument('--valid_GT_path', type=str, default='./dataset03/valid_GT/')
    parser.add_argument('--test_path', type=str, default='./dataset03/test/')
    parser.add_argument('--test_GT_path', type=str, default='./dataset03/test_GT/')
